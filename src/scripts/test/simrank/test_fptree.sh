...
inputFS=$thisDir/../../../../resources/small_no_loop.path10.sort
input=file:///$inputFS
...
"$hadoop_dir"/bin/hadoop jar $thisDir/../../../dep/java/FingerprintTree.jar $classname $input $output

cat $outputFS/part* > $outputFS/hadoop.out

python $thisDir/../../main/simrank/compute_tree.py $inputFS $outputFS/python.out
